    ...
    >
        <g clip-path="url(#clip0_11393_56976)">
            ...
            <path
                ...
                fill="url(#paint0_radial_11393_56976-uid-4)"
            ></path>
            <path
                d="M39.412 60.838c-8.154 1.602-16.017 4.368-23.297 8.3-5.096 2.766-8.882 7.28-10.775 12.667-2.912 8.3-1.019 17.473 5.097 23.88 4.95 5.241 11.502 8.59 18.783 9.318 8.59 1.02 17.181.728 25.772-.873l-6.116-55.185-9.464 1.893z"
                fill="url(#paint1_radial_11393_56976-uid-4)"
            ></path>
            <path
                ...
                fill="url(#paint2_linear_11393_56976-uid-4)"
            ></path>
            <path
            ...
            <path
                ...
                fill="url(#paint3_linear_11393_56976-uid-4)"
            ></path>
            <path
            ...
            <path
                ...
                fill="url(#paint4_radial_11393_56976-uid-4)"
            ></path>
            <path
                d="M25.87 101.17c7.135-2.766 13.396-7.717 17.765-14.123l.29-.437 17.473-3.495c3.786-.728 6.116-4.368 5.388-8.008-.728-3.64-4.077-5.97-7.572-5.533a232.17 232.17 0 01-20.239 1.747l-5.533.291-11.212.583"
                fill="url(#paint5_radial_11393_56976-uid-4)"
            ></path>
            <path
                opacity=".5"
                ...
                fill="url(#paint6_radial_11393_56976-uid-4)"
            ></path>
            <path
                opacity=".5"
                ...
                fill="url(#paint7_radial_11393_56976-uid-4)"
            ></path>
            <path
        ...
        <defs>
            <radialGradient
                id="paint0_radial_11393_56976-uid-4"
                cx="0"
                cy="0"
                r="1"
            ...
            <radialGradient
                id="paint1_radial_11393_56976-uid-4"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
            ...
            <radialGradient
                id="paint4_radial_11393_56976-uid-4"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
            ...
            <radialGradient
                id="paint5_radial_11393_56976-uid-4"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
            ...
            <radialGradient
                id="paint6_radial_11393_56976-uid-4"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
            ...
            <radialGradient
                id="paint7_radial_11393_56976-uid-4"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
            ...
            <linearGradient
                id="paint2_linear_11393_56976-uid-4"
                x1="68.877"
                y1="117.93"
                x2="98.832"
                y2="14.675"
            ...
            <linearGradient
                id="paint3_linear_11393_56976-uid-4"
                x1="99.523"
                y1="12.971"
                x2="103.355"
                y2="4.544"
            ...
            <clipPath id="clip0_11393_56976-uid-4">
